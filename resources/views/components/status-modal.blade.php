        ...
        <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <form id="updateStatusForm" method="POST" action="/api/schedules/{{ $schedule->id }}">
                    @csrf
                    @method('PUT') <!-- Gunakan metode PUT untuk rute Anda -->
                    ...
                    <div class="mt-4">
                        ...
                        <select name="status_id" id="status"
                            ...
                            <option value="1" {{ $schedule->status_id == 1 ? 'selected' : '' }}>Ada</option>
                            <option value="2" {{ $schedule->status_id == 2 ? 'selected' : '' }}>Tidak Ada</option>
                            <option value="3" {{ $schedule->status_id == 3 ? 'selected' : '' }}>Dimulai</option>
                            <option value="4" {{ $schedule->status_id == 4 ? 'selected' : '' }}>Selesai</option>
                        </select>
                    </div>
